...
if (amysAge > brittanisAge) {
  ...
  console.log("They both are the same age");
}
...
//CODE HERE
// if (temperature == 80 || temperature > 80 && rain == true) {
if (temperature >= 80 && rain == true) {
  ...
  console.log("one should wear a sweatshirt");
} else if (temperature <= 60 && rain !== true) {
  console.log("one should wear a sweatshirt and gloves");
}
